...
import {UserCircleIcon,Cog6ToothIcon,PowerIcon, UsersIcon} from "@heroicons/react/24/solid";
...
export function SidebarWithLogo() {
    ...
    return (
        <Card placeholder={''} className="h-screen w-full p-4 shadow-xl  ">
            <ConfirmDialog />
            <div className="mb-2 flex items-center gap-2 p-2 cursor-pointer" onClick={()=> {navigate('/dashboard')}}>
                <img
                    src="/logo.png"
                    alt="brand"
                    className="h-8 w-8"
